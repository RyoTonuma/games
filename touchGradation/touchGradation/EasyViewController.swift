...
class EasyViewController: UIViewController {
    ...
    //それぞれのボタンが何番めに薄いか
    var colors:[Int] = Array(count: 9, repeatedValue: 0)
    ...
    override func viewDidLoad() {
        ...
        button1.layer.position = CGPointMake(self.view.frame.width/2 - 110, self.view.frame.height/2 - 110)
        
        button2.frame = CGRectMake(0, 0, 100, 100)
        button2.layer.cornerRadius = 10.0
        button2.layer.position = CGPointMake(self.view.frame.width/2, self.view.frame.height/2 - 110)
        
        button3.frame = CGRectMake(0, 0, 100, 100)
        button3.layer.cornerRadius = 10.0
        button3.layer.position = CGPointMake(self.view.frame.width/2 + 110, self.view.frame.height/2 - 110)
        
        button4.frame = CGRectMake(0, 0, 100, 100)
        button4.layer.cornerRadius = 10.0
        button4.layer.position = CGPointMake(self.view.frame.width/2 - 110, self.view.frame.height/2)
        
        button5.frame = CGRectMake(0, 0, 100, 100)
        button5.layer.cornerRadius = 10.0
        button5.layer.position = CGPointMake(self.view.frame.width/2, self.view.frame.height/2)
        
        button6.frame = CGRectMake(0, 0, 100, 100)
        button6.layer.cornerRadius = 10.0
        button6.layer.position = CGPointMake(self.view.frame.width/2 + 110, self.view.frame.height/2)
        
        button7.frame = CGRectMake(0, 0, 100, 100)
        button7.layer.cornerRadius = 10.0
        button7.layer.position = CGPointMake(self.view.frame.width/2 - 110, self.view.frame.height/2 + 110)
        
        button8.frame = CGRectMake(0, 0, 100, 100)
        button8.layer.cornerRadius = 10.0
        button8.layer.position = CGPointMake(self.view.frame.width/2, self.view.frame.height/2 + 110)
        
        button9.frame = CGRectMake(0, 0, 100, 100)
        button9.layer.cornerRadius = 10.0
        button9.layer.position = CGPointMake(self.view.frame.width/2 + 110, self.view.frame.height/2 + 110)
    ...
    //透明度を重複なしランダムに振り分ける
    func randColors(){
        var tmpArray:[Int] = Array(count: 9, repeatedValue: 1)
        var leftCount:Int = 9
        for i in 0...8 {
    ...
    func changeColor(buttonNum:Int, redNum:CGFloat, greenNum:CGFloat, blueNum:CGFloat,alphaNum:Int){
        switch buttonNum {
        case 1:
            button1.backgroundColor = UIColor(red:redNum,green:greenNum,blue:blueNum,alpha:CGFloat(alphaNum)/9)
        case 2:
            button2.backgroundColor = UIColor(red:redNum,green:greenNum,blue:blueNum,alpha:CGFloat(alphaNum)/9)
        case 3:
            button3.backgroundColor = UIColor(red:redNum,green:greenNum,blue:blueNum,alpha:CGFloat(alphaNum)/9)
        case 4:
            button4.backgroundColor = UIColor(red:redNum,green:greenNum,blue:blueNum,alpha:CGFloat(alphaNum)/9)
        case 5:
            button5.backgroundColor = UIColor(red:redNum,green:greenNum,blue:blueNum,alpha:CGFloat(alphaNum)/9)
        case 6:
            button6.backgroundColor = UIColor(red:redNum,green:greenNum,blue:blueNum,alpha:CGFloat(alphaNum)/9)
        case 7:
            button7.backgroundColor = UIColor(red:redNum,green:greenNum,blue:blueNum,alpha:CGFloat(alphaNum)/9)
        case 8:
            button8.backgroundColor = UIColor(red:redNum,green:greenNum,blue:blueNum,alpha:CGFloat(alphaNum)/9)
        case 9:
            button9.backgroundColor = UIColor(red:redNum,green:greenNum,blue:blueNum,alpha:CGFloat(alphaNum)/9)
        default:
            println("errorB")
        }
    }
    ...
    func reset(){
        ...
        if instNum == 0 {
            ...
            for i in 0...8{
                changeColor(i+1,redNum: redRand,greenNum: greenRand,blueNum: blueRand ,alphaNum: 10 - colors[i])
            }
